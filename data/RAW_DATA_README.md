...
## 📊 Dataset Profile (Raw Source)

This section contains metadata regarding the raw `airlines_delay.csv` file used as the base reference for this project.

* **File Name:** `airlines_delay_sample.csv`
* **File Size:** `18.63 MB`
* **Total Rows:** `539382` rows (including header)
* **Total Columns:** `8` columns
* **Target Variable:** `Class` (Binary delay status: 0 = On Time, 1 = Delayed)

### Column Distribution Summary
* **Categorical / Text Columns:** `Airline`, `AirportFrom`, `AirportTo`
* **Numerical Columns:** `Flight`, `Time`, `Length`, `DayOfWeek`, `Class`
---
